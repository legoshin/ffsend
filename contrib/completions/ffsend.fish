...
complete -c ffsend -n "__fish_seen_subcommand_from upload" -l collect-downloader-info -d 'Require downloaders to provide name and email; report sent to business@ge.mba'
